...
import './home.css';
import qrCodeImage from '../assest/qr-code (1).png';
...
>
  Enjoyed Your Stay? Review Us on Google
                ...
                <div className="card-footer">
                    <h2 className="footer-hotel-name">Crossroads Inn</h2>
                    <p className="footer-hotel-tagline">7050 Okeechobee Rd, Fort Pierce, FL 34945, USA</p>
                </div>
            </div>
        </div>
    );
